  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500 pb-20">
      ...
      <section className="pb-10 border-b border-zinc-100">
        <SectionHeader icon={Layout} title="Layout & Allineamento" colorClass="text-zinc-500" />
        <LayoutFields 
        ...
        <div className="mt-8 space-y-8">
            ...
            <div className="pt-6 border-t border-zinc-50">
              <SectionHeader icon={Map} title="Stile Mappa" colorClass="text-blue-500" />
              <SimpleSlider 
      ...
      {/* 2. Tipografia */}
      <section className="pb-10 border-b border-zinc-100">
        <SectionHeader icon={Type} title="Stile Testi & Icone" colorClass="text-indigo-500" />
