...
import { LayoutFields, ColorManager, BorderShadowManager, SectionHeader, TypographyFields, SimpleSlider, BackgroundManager, PatternManager, AnchorManager, AnimationManager } from '@/components/blocks/sidebar/SharedSidebarComponents';
