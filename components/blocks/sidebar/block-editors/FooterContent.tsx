      ...
      <div className="space-y-8">
         <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-zinc-50 rounded-2xl border border-zinc-100">
               <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest leading-none">Mostra Logo</label>
               <div
            ...
            {selectedBlock.content.showLogo !== false && (
               <div className="space-y-4 pt-2">
                  <div className="flex gap-2 p-1 bg-zinc-100 rounded-xl">
                     <button onClick={() => updateContent({ logoType: 'text' })} className={cn("flex-1 py-1 text-[10px] font-black uppercase rounded-lg transition-all", selectedBlock.content.logoType !== 'image' ? 'bg-white text-zinc-900 shadow-sm' : 'bg-transparent text-zinc-400 hover:text-zinc-600')}>Testo</button>
                     <button onClick={() => updateContent({ logoType: 'image' })} className={cn("flex-1 py-1 text-[10px] font-black uppercase rounded-lg transition-all", selectedBlock.content.logoType === 'image' ? 'bg-white text-zinc-900 shadow-sm' : 'bg-transparent text-zinc-400 hover:text-zinc-600')}>Immagine</button>
                  </div>
            ...
            <div className="pt-4 mt-6 border-t border-zinc-100">
               <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest block mb-2">Testo Copyright</label>
