...
import {
  Plus, Loader2, Trash2, Languages, BookOpen,
  Eye, EyeOff, Calendar, Search,
} from 'lucide-react';
...
import type { BlogPost, Page, Project } from '@/types/editor';
...
interface BlogTabProps {
  ...
  setBlogLangFilter: (v: string) => void;
  deletingBlogPostId: string | null;
  setDeletingBlogPostId: (v: string | null) => void;
